...
def generate_pdf(
    ...
    doc = SimpleDocTemplate(
        ...
        title=f"{repo_name} — RepoGraph Analysis",
        author="RepoGraph",
    )
    s = _styles()
    story = []
    ...
    trace_data = [
        ...
        ["Tool Calls", str(agent_tool_calls)],
        ["Analysis Time", f"{elapsed_seconds:.1f}s"],
    ...
    def on_page(canvas, doc):
        ...
        canvas.drawString(margin, 0.8 * cm, f"RepoGraph | {repo_name}")
